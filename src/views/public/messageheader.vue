<template>
    <div>
        ...
        <div style="display:flex;display:-webkit-flex">
            ...
            <a-select defaultValue="覆盖原报文头" style="width: 120px;margin-left:10px;" @change="handleChange">
              <a-select-option value="1">覆盖原报文头</a-select-option>
              <a-select-option value="2">不覆盖原报文头</a-select-option>
            </a-select>
