    ...
    <div>
        ...
        <a-row>
            <a-col :span="6" class="flex">
                ...
                <a-input placeholder="请输入元数据名称" style="width:150px ;"/>
            </a-col>
            <a-col :span="6" class="flex">
                <div class="ename"> 系统英文名称	</div>
                <a-input placeholder="请输入中文名称"  style="width:150px;"/>
            </a-col>
            <a-col  :span="6" class="flex">
                <div class="ename">系统能否改造</div>
                <a-input placeholder="请输入类别词"  style="width:150px;"/>
            </a-col>
            <a-col  :span="6" class="flex">
                <div class="ename">改造说明	</div>
                <a-input placeholder="请输入数据项分类"  style="width:150px;"/>
            </a-col>
        ...
        <a-row>
            <a-col  :span="6" class="flex">
                ...
                <a-input placeholder="请输入创建人"  style="width:150px;"/>
            </a-col>
             <a-col  :span="6" class="flex">
